...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/typesystem-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6418&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/typesystem-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `typesystem` can be installed with:

```
conda install typesystem
```

It is possible to list all of the versions of `typesystem` available on your platform with:
